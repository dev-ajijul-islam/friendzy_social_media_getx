...
class FullImageScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final FullImageViewController controller =
    Get.put(FullImageViewController(), tag: 'fullImageViewer_${DateTime.now().millisecondsSinceEpoch}');
              ...
              itemBuilder: (context, index) {
                return PhotoView(
                  ...
                  heroAttributes: PhotoViewHeroAttributes(
                    tag: 'image_${images[index]}_$index',
                  ),
